            ...
            {!error && loading ? (
                ...
                <>
                    <div
                        ...
                        style={{
                            height: "30vh",
                            backgroundImage: `url("${packageData.img_url}")`,
                        ...
                        <div className="w-full md:w-4/6">
                            <div className="flex flex-wrap items-center space-y-1 md:space-y-0 space-x-3">
                                ...
                                <div className="min-w-max flex items-center bg-blue-50 border border-blue-600 rounded-full py-0.5 px-2 text-sm text-blue-600">
                                    ...
                                    <p className="font-semibold">
                                        {packageData.tour.location}
                                    </p>
                                </div>
                                <div className="min-w-max flex items-center bg-blue-50 border border-blue-600 rounded-full py-0.5 px-2 text-sm text-blue-600">
                                    <LuTicket className="text-blue-500 text-lg mr-2.5" />
                                    <p className="font-semibold">
                                        Min age – {packageData.tour.min_age}
                                    </p>
                                </div>
                            </div>
                            <div className="w-full">
                                <TabGroup>
                                            ...
                                            <div className="py-4">
                                                ...
                                                <p
                                                    ...
                                                    dangerouslySetInnerHTML={{
                                                        __html: packageData.tour.tour_details.replace(
                                                            /\n/g,
                                                            "<br />"
                                                        ),
                                                    }}
                                                ...
                                                <ul className="px-5 md:pl-0 list-disc space-y-3">
                                                    {packageData.tour.destinations_covered.map(
                                                        (
                                                            d: any,
                                                            idx: number
                                                        ) => (
                                        ...
                                        <TabPanel>
                                            <div className="py-4">
                                                ...
                                                <ul className="px-5 md:pl-0 mt-1 list-disc space-y-3">
                                                    {packageData.tour.itinerary_outline.map(
                                                        (
                                                            i: any,
                                                            idx: number
                                                        ) => (
                                                ...
                                                <Accordion
                                                    ...
                                                    className="w-full"
                                                >
                                                    {packageData.tour.detailed_itinerary.map(
                                                        (
                                                            i: any,
                                                            idx: number
                                                        ) => (
                                    ...
                                    <div className="flex items-stretch space-x-5">
                                        ...
                                        <TabPanel>
                                            <div className="pt-4">
                                                {packageData.tour.important_information.map(
                                                    (i: any, idx: number) => (
                                                        <div
                                                            key={idx}
                                                            className="mb-5"
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600 font-medium mb-3">
                                                    Do not hesitage to send us
                                                    an email. Our team is made
                                                    up of experts who are more
